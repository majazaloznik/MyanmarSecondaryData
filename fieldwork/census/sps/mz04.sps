...
CROSSTABS
  /TABLES= p09_disablity_sum  BY p04_sex p05_age_binned_5 p05_age_binned_10 p21_highest_grade p22_activity_status batch_urban_rural p26_children_in_hh_bound p27_children_else_bound
 h32_type_residence h33_type_ownership
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
