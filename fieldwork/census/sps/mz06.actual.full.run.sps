...
OMS
  ...
  /DESTINATION FORMAT=SAV NUMBERED=TableNumber_
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\GL01.sav' VIEWER=YES
  /TAG='GL01.SAV'.
...
OMS
  ...
  /DESTINATION FORMAT=XLSX
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\GL01.xlsx' VIEWER=YES
  /TAG='GL01.XLSX'.
...
CROSSTABS
  /TABLES= p09a_disability_seeing BY p05_age_binned sex_head marital_status_head
...
CROSSTABS
  /TABLES= p09b_disability_hearing BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p09c_disability_walking BY p05_age_binned  sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p09d_disability_remembering BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p09_disablity_sum BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p09_disablity_rescaled_sum BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p09_disablity_dummy_sum BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p11_birth_township_c2 BY p05_age_binned  sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p12_birth_ur BY p05_age_binned  sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p15_duration_of_residence_5 BY p05_age_binned  sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p16_reason_for_movement BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p17_prev_res_township_c2 BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p18_prev_res_ur BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h32_type_residence BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h33_type_ownership BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h34_lighting BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h35a_drinking_water BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h35b_non_drinking_water BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h36_cooking_fuel BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h37_toilet BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h38a_roof BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h38b_walls BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h38c_floor BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39a_radio BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39b_television BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39c_land_line_phone BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39d_mobile_phone BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39e_computer BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39f_internet_at_home BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39g_car_truck_van BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39h_motorcycle_moped BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39i_bicycle BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39j_4_wheel_tractor BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39k_canoe_boat BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39l_motor_boat BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39m_cart_bullock BY p05_age_binned sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=SAV NUMBERED=TableNumber_
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\GL02.sav' VIEWER=YES
  /TAG='GL02.SAV'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=XLSX
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\GL02.xlsx' VIEWER=YES
  /TAG='GL02.XLSX'.

************************************************************************************

CROSSTABS
  /TABLES=  p25_children_born_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p25a_children_born_male_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p25b_children_born_female_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p26_children_in_hh_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p26a_children_in_hh_male_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p26b_children_in_hh_female_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p27_children_else_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p27a_children_else_male_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p27b_children_else_female_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p28_children_died_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p28a_children_died_male_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p28b_children_died_female_bound BY p05_age_binned  p06_marital_status
   number_of_people_bound unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=SAV NUMBERED=TableNumber_
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\GL03.sav' VIEWER=YES
  /TAG='GL03.SAV'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=XLSX
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\GL03.xlsx' VIEWER=YES
  /TAG='GL03.XLSX'.


CROSSTABS
  /TABLES= p09_disablity_dummy_sum  BY  p04_sex p05_age_binned  number_of_people_bound 
unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural p26_children_in_hh_bound 
p26a_children_in_hh_male_bound p26b_children_in_hh_female_bound p27_children_else_bound p27a_children_else_male_bound 
p27b_children_else_female_bound h32_type_residence h33_type_ownership
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p09_disablity_sum  BY  p04_sex p05_age_binned  number_of_people_bound 
unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural p26_children_in_hh_bound 
p26a_children_in_hh_male_bound p26b_children_in_hh_female_bound p27_children_else_bound p27a_children_else_male_bound 
p27b_children_else_female_bound h32_type_residence h33_type_ownership
  /FORMAT=AVALUE TABLES
...
CROSSTABS
  /TABLES= p09_disablity_rescaled_sum  BY p04_sex p05_age_binned  number_of_people_bound 
unique_generations p21_highest_grade_c7 p22_activity_status batch_urban_rural p26_children_in_hh_bound 
p26a_children_in_hh_male_bound p26b_children_in_hh_female_bound p27_children_else_bound p27a_children_else_male_bound 
p27b_children_else_female_bound h32_type_residence h33_type_ownership
  /FORMAT=AVALUE TABLES
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=SAV NUMBERED=TableNumber_
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\GL03.2.sav' VIEWER=YES
  /TAG='GL03.2.SAV'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=XLSX
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\GL03.2.xlsx' VIEWER=YES
  /TAG='GL03.2.XLSX'.


CROSSTABS
  /TABLES= p09_disablity_dummy_sum  BY  p04_sex by p05_age_binned 
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.

CROSSTABS
  /TABLES= p09_disablity_sum  BY  p04_sex by p05_age_binned  
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.

CROSSTABS
  /TABLES= p09_disablity_rescaled_sum  BY p04_sex by p05_age_binned  
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT 
  /COUNT ROUND CELL.


OMSEND TAG=['GL03.2.SAV'].
OMSEND TAG=['GL03.2.XLSX'].
OUTPUT CLOSE *.


************************************************************************************
************************************************************************************
* EXTRA CROSSTABS - PART THREE - REPEATED FOR HOH OVER 60
************************************************************************************
* select only hoh over 60

DATASET ACTIVATE MainFile.
USE ALL.
COMPUTE filter_$=(p03_relationship = 1 &  p05_age>= 60).
VARIABLE LABELS filter_$ 'p03_relationship = 1 &  p05_age>= 60 (FILTER)'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=SAV NUMBERED=TableNumber_
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ01.sav' VIEWER=YES
  /TAG='MZ01.SAV'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=XLSX
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ01.xlsx' VIEWER=YES
  /TAG='MZ01.XLSX'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=SAV NUMBERED=TableNumber_
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ01.2.sav' VIEWER=YES
  /TAG='MZ01.2.SAV'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=XLSX
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ01.2.xlsx' VIEWER=YES
  /TAG='MZ01.2.XLSX'.
...
OMSEND TAG=['MZ01.2.SAV'].
OMSEND TAG=['MZ01.2.XLSX'].
...
************************************************************************************
************************************************************************************
* EXTRA CROSSTABS - PART THREE - REPEATED FOR HOH OVER 85
************************************************************************************
* select only hoh over 85

DATASET ACTIVATE MainFile.
USE ALL.
COMPUTE filter_$=(p03_relationship = 1 &  p05_age>= 85).
VARIABLE LABELS filter_$ 'p03_relationship = 1 &  p05_age>= 85 (FILTER)'.
VALUE LABELS filter_$ 0 'Not Selected' 1 'Selected'.
FORMATS filter_$ (f1.0).
FILTER BY filter_$.
EXECUTE.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=SAV NUMBERED=TableNumber_
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ02.sav' VIEWER=YES
  /TAG='MZ02.SAV'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=XLSX
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ02.xlsx' VIEWER=YES
  /TAG='MZ02.XLSX'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=SAV NUMBERED=TableNumber_
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ02.2.sav' VIEWER=YES
  /TAG='MZ02.2.SAV'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=XLSX
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ02.2.xlsx' VIEWER=YES
  /TAG='MZ02.2.XLSX'.
...
OMSEND TAG=['MZ02.2.SAV'].
OMSEND TAG=['MZ02.2.XLSX'].
FILTER OFF.
USE ALL.
EXECUTE.
...
************************************************************************************
************************************************************************************
* EXTRA CROSSTABS - PART THREE - REPEATED FOR HOH OVER 60 and in farming occupation 
************************************************************************************
* select only hoh over 60

DATASET ACTIVATE MainFile.
USE ALL.
COMPUTE filter_$=(p03_relationship = 1 &  p05_age>= 60 & p23_occupation >= 611 & p23_occupation <= 634).
VARIABLE LABELS filter_$ 'p03_relationship = 1 &  p05_age>= 60 (FILTER)'.
VALUE LABELS filter_$ 0 'Not Selected' 1 'Selected'.
FORMATS filter_$ (f1.0).
FILTER BY filter_$.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=SAV NUMBERED=TableNumber_
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ03.sav' VIEWER=YES
  /TAG='MZ03.SAV'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=XLSX
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ03.xlsx' VIEWER=YES
  /TAG='MZ03.XLSX'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=SAV NUMBERED=TableNumber_
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ03.2.sav' VIEWER=YES
  /TAG='MZ03.2.SAV'.
...
OMS
  ...
  /IF COMMANDS=['Crosstabs'] SUBTYPES=['Crosstabulation']
  /DESTINATION FORMAT=XLSX
   OUTFILE='C:\Users\Dell\Documents\IBM\SPSS\Statistics\census\output\MZ03.2.xlsx' VIEWER=YES
  /TAG='MZ03.2.XLSX'.
...
OMSEND TAG=['MZ03.2.SAV'].
OMSEND TAG=['MZ03.2.XLSX'].
