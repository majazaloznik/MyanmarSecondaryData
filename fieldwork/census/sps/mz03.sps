...
RECODE  p05_age (MISSING=COPY) (LO THRU 20=1) (LO THRU 30=2) (LO THRU 40=3) (LO THRU 50=4) (LO 
    THRU 60=5) (LO THRU 70=6) (LO THRU 80=7) (LO THRU 90=8) (LO THRU HI=9) (ELSE=SYSMIS) INTO 
    p05_age_binned_10.
VARIABLE LABELS p05_age_binned_10 'Age (Binned)'.
FORMATS  p05_age_binned_10 (F5.0).
VALUE LABELS  p05_age_binned_10 1 '<= 20' 2 '21 - 30' 3 '31 - 40' 4 '41 - 50' 5 '51 - 60' 6 '61 - 70' 7 
    '71 - 80' 8 '81 - 90' 9 '91+'.
VARIABLE LEVEL  p05_age_binned_10 (ORDINAL).
exe.
...
variable labels p28_children_died_bound  'Children still in hh (bounded)'.
...
CROSSTABS
  /TABLES= p09a_disability_seeing BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
...
CROSSTABS
  /TABLES= p09b_disability_hearing BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p09c_disability_walking BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p09d_disability_remembering BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p11_birth_township_c2 BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p12_birth_ur BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p15_duration_of_residence_5 BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p16_reason_for_movement BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p17_prev_res_township_c2 BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p18_prev_res_ur BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h32_type_residence BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h33_type_ownership BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h34_lighting BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h35a_drinking_water BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h35b_non_drinking_water BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h36_cooking_fuel BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h37_toilet BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h38a_roof BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h38b_walls BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h38c_floor BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39a_radio BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39b_television BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39c_land_line_phone BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39d_mobile_phone BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39e_computer BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39f_internet_at_home BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39g_car_truck_van BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39h_motorcycle_moped BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39i_bicycle BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39j_4_wheel_tractor BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39k_canoe_boat BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39l_motor_boat BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= h39m_cart_bullock BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p25_children_born_bound BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p26_children_in_hh_bound BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p27_children_else_bound BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p28_children_died_bound BY p05_age_binned_5 p05_age_binned_10 sex_head marital_status_head
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT COLUMN row
  /COUNT ROUND CELL.
...
OUTPUT EXPORT 
  /CONTENTS  EXPORT=ALL LAYERS=ALL MODELVIEWS=ALL
  /REPORT  DOCUMENTFILE='C:\Users\Dell\Documents\MNMcensus-GL-Part2-1percent.htm'
     TITLE=FILENAME FORMAT=HTML RESTYLE=YES.
...
CROSSTABS
  /TABLES= p09_disablity_sum  BY p04_sex p05_age_binned_5 p05_age_binned_10
   number_of_people_bound unique_generations p21_highest_grade p22_activity_status batch_urban_rural p26_children_in_hh_bound p27_children_else_bound
